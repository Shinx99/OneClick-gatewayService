    ...
    public SecurityWebFilterChain filterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchanges -> exchanges
                        ...
                        // ========== CV MARKET APIs (branch feature) ==========
                        .pathMatchers(HttpMethod.GET, "/api/recruitment/candidate/profile/resume/fetchAll").permitAll()
                        .pathMatchers(HttpMethod.GET, "/api/recruitment/candidate/profile/resume/fetchResumeById/{resumeId}")
                        .hasAnyAuthority("ROLE_recruiter", "ROLE_candidate")
